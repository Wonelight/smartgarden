...
public interface WeatherDataRepository extends JpaRepository<WeatherData, Long> {
        ...
        /**
         * Tìm weather data mới nhất trong khoảng thời gian cho một location (dùng cho
         * BatchJob).
         */
        Optional<WeatherData> findTopByLocationAndForecastTimeBetweenOrderByForecastTimeDesc(
